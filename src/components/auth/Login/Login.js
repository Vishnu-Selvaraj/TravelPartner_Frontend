    ...
    if(!email){
      ...
      setError('Password field required.')
       ...
       try{
        ...
        localStorage.removeItem("userToken"); {/* Remove the null value and set the token */}
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              ...
              <div className="d-flex justify-content-center mt-1">
                <p className="h6" style={{fontSize:'14px'}}>Don't have an account? <Link to='/signup' className="card-link fw-bold text-decoration-none">Signup</Link></p>
              </div>
            </div>
          </div>
        </div>
