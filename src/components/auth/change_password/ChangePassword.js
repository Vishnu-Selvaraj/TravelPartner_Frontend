  ...
  return (
      ...
      <div className="container mt-4">
        <div className="row d-flex justify-content-center">
          <div
            className="col-11 col-sm-10 col-md-8"
            id="loginCard"
          >
            <div className="card py-3 text-white" id="changePasswordInnerCard">
              <div className="card-body">
                <h5 className="text-center card-title fs-2 mb-4 changePasswordHeading">Change Password</h5>
                ...
                <form method="post">
                  ...
                  />
                  <label htmlFor="passwordConf" className='form-label text-dark'>Confirm Password:</label>
                  <input
                    className="form-control form-control-sm mb-4 "
                    type="password"
